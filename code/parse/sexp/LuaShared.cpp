 ...
 */
int shared_check_ship_visibility(const ship *viewed, ship *viewer)
{
	if(!viewer)
	{
		...
		{
			mprintf(("In multiplayer shared_check_ship_visibility must have two arguments!  Defaulting to the first player.\n"));
