	...
	"number", "Returns 0 - not visible, 1 - partially visible, 2 - fully visible")
{
	...
	return ade_set_args(L, "i", shared_check_ship_visibility(viewed_shipp,viewer_shipp));
}
