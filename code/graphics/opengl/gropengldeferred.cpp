...

	{
		...
		for (auto& l : Lights) {
			...
			case Light_Type::Point:
				...
				light_data->scale.xyz.x = MAX(l.rada, l.radb);
				light_data->scale.xyz.y = MAX(l.rada, l.radb);
				light_data->scale.xyz.z = MAX(l.rada, l.radb);
				break;
			case Light_Type::Tube: {
				...
				light_data->scale.xyz.x = l.radb;
				light_data->scale.xyz.y = l.radb;
